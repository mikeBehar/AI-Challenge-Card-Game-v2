# Case 2: TrendSetters Retail - Marketing AI Decision
...
- **[case-study.md](case-study.md)**: Complete case study with company background, financial data, stakeholder perspectives, and decision options
- **[blackboard-assignments.md](blackboard-assignments.md)**: Pre-meeting assignments for students including analysis questions and AI collaboration prompts
- **[google-form-voting.md](google-form-voting.md)**: Voting structure and deliberation guide for board meeting simulation
- **[ideal-answers.md](ideal-answers.md)**: Teaching guide with example responses and grading criteria
...
Students will:
1. Analyze complex business decisions involving AI technology investments
2. Evaluate trade-offs between innovation, privacy, and financial performance
3. Practice AI collaboration for business analysis and decision support
4. Engage in professional deliberation with diverse stakeholder perspectives
5. Develop business acumen around marketing technology and customer data
...
1. Read [case-study.md](case-study.md) carefully - note specific numbers and stakeholder arguments
2. Complete assignments in [blackboard-assignments.md](blackboard-assignments.md)
3. Use AI tools thoughtfully to deepen your understanding (not to do your thinking)
4. Come prepared to engage with peers who disagree with you
...
See [ideal-answers.md](ideal-answers.md) for:
...
The /scripts directory contains Google Apps Script files. When pasted into a new project at script.google.com, these scripts will automatically generate Google Forms and Google Slides presentations based on the case study content.
